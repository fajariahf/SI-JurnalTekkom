...
<body>
    ...
    <form action="<?php echo base_url();?>Coba/create" method="post">
    ...
    <form action="<?php echo base_url();?>Coba/update" method="post">
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <div class="form-group row">
                    <label class="col-sm-2 col-form-label">Package</label>
                    <div class="col-sm-10">
                      <input readonly type="text" name="package_edit" class="form-control" placeholder="Package Name" required>
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-2 col-form-label">Product</label>
    ...
    <form action="<?php echo base_url();?>Coba/delete" method="post">
